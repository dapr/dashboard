...
var (
	//TODO: dapr-placement left for backward compatability, can be removed after v1.0 release
	controlPlaneLabels = [...]string{"dapr-operator", "dapr-sentry", "dapr-placement", "dapr-placement-server", "dapr-sidecar-injector"}
)
